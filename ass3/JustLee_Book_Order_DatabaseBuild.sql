...
DROP TABLE books_department;

DROP TABLE PUBLISHER3 ;
...
CREATE TABLE bEmployees (
 ...
 MTHSAL                 NUMBER(7,2),
 MGR                 NUMBER(4),
 CONSTRAINT bemployees_empno_PK PRIMARY KEY (EMPNO));

INSERT INTO bemployees VALUES (7839,'KING','BEN', 'GTECH2',TO_DATE('17-NOV-91','DD-MON-YY'),10,6000,NULL);
INSERT INTO bEmployees VALUES (8888,'JONES','LARRY','MTech2',TO_DATE('17-NOV-98','DD-MON-YY'),10,4200,7839);
INSERT INTO bEmployees VALUES (7344,'SMITH','SAM','GTech1',TO_DATE('17-NOV-95','DD-MON-YY'),20,4900,7839);
INSERT INTO bEmployees VALUES (7355,'POTTS','JIM','GTech1',TO_DATE('17-NOV-95','DD-MON-YY'),20,4900,7839);
INSERT INTO bEmployees VALUES (8844,'STUART','SUE','MTech1',TO_DATE('17-NOV-98','DD-MON-YY'),10,3700,8888);
COMMIT;
ALTER TABLE bemployees ADD (region CHAR(2));
...
DROP TABLE books_employees CASCADE CONSTRAINTS;
CREATE TABLE books_employees (
 EMPNO               NUMBER(4),
 LNAME               VARCHAR2(20),
 FNAME               VARCHAR2(15),
 JOB                 VARCHAR2(9),
 ...
 BONUS               NUMBER(6,2),
 MGR                 NUMBER(4),
 CONSTRAINT books_employees_empno_PK PRIMARY KEY (EMPNO));

INSERT INTO books_employees VALUES (7839,'KING','BEN', 'GTECH2',TO_DATE('17-NOV-91','DD-MON-YY'),10,6000,3000,NULL);
INSERT INTO books_employees VALUES (8888,'JONES','LARRY','MTech2',TO_DATE('17-NOV-98','DD-MON-YY'),10,4200,1200,7839);
INSERT INTO books_employees VALUES (7344,'SMITH','SAM','GTech1',TO_DATE('17-NOV-95','DD-MON-YY'),20,4900,1500,7839);
INSERT INTO books_employees VALUES (7355,'POTTS','JIM','GTech1',TO_DATE('17-NOV-95','DD-MON-YY'),20,4900,1900,7839);
INSERT INTO books_employees VALUES (8844,'STUART','SUE','MTech1',TO_DATE('17-NOV-98','DD-MON-YY'),10,3700,NULL,8888);
COMMIT;
...
Create Table books_department
 (deptno NUMBER(2),
  dname VARCHAR2(20))
;


INSERT INTO books_department
